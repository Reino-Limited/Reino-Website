  ...
  return (
    <section className="bg-reino-gold py-24 px-4 overflow-hidden relative">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="max-w-6xl mx-auto bg-reino-navy p-6 sm:p-10 md:p-16 shadow-2xl relative z-10 border border-white/5"
      >
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="lg:w-3/5">
            ...
            <h2 className="text-white text-3xl md:text-5xl font-serif font-semibold mb-8 leading-tight uppercase">
              Master the art of <br />
              <span className="text-reino-gold">decision intelligence.</span>
            </h2>
            <p className="text-reino-muted text-base md:text-lg leading-relaxed mb-8 border-l-2 border-reino-gold pl-6 font-sans font-normal">
            ...
            <div className="flex items-center gap-4 text-white/80 italic">
              ...
              <span className="text-sm md:text-base">the more AI automation tools are used, the more valuable human judgment becomes.</span>
            </div>
          </div>

          <div className="lg:w-1/3 w-full text-center bg-white/5 p-6 sm:p-8 backdrop-blur-sm border border-white/10 rounded-sm">
            <p className="text-reino-gold text-xs uppercase tracking-widest mb-4 font-sans font-extrabold">Phase One Focus</p>
            <h3 className="text-white text-xl sm:text-2xl font-serif font-semibold mb-6 uppercase break-words tracking-tight">
